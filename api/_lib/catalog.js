...
export const PRODUCTS=[
  ...
  },
  {
    ...
    variants:[{name:'Padrão',swatch:'#111111',images:[{src:'https://www.qcy.com/cdn/shop/files/T13_-1_9fa983e0-67da-414e-84f3-36ae8d373764.png?v=1779672668&width=1946',alt:'Fone Bluetooth QCY T13 com estojo'}]}],
  ...
  },
  {
    ...
    variants:[{name:'Padrão',swatch:'#d9cfb4',images:[{src:'https://i02.appmifile.com/220_operator_sg/23/05/2023/db37e9f72ec6603c87f43b8cef099ba6.png',alt:'Xiaomi Smart Band 8'}]}],
  ...
  },
  {
    ...
    variants:[{name:'Padrão',swatch:'#101010',images:[{src:'https://vn.jbl.com/dw/image/v2/AAUJ_PRD/on/demandware.static/-/Sites-masterCatalog_Harman/default/dw15a095de/JBL_GO_4_HERO_BLACK_48156_x4.png?sfrm=png&sw=537',alt:'Caixa de som JBL GO 4'}]}],
  ...
  },
  {
    ...
    variants:[{name:'Padrão',swatch:'#f2f2f2',images:[{src:'https://cz.baseus.com/cdn/shop/files/file_3e6e7c34-c6d1-41e0-91e0-08171c95a7ce.jpg?v=1748248170&width=1200',alt:'Carregador Baseus Super Si 20W'}]}],
  ...
  },
  {
    ...
    variants:[{name:'Padrão',swatch:'#eeeeee',images:[{src:'https://i02.appmifile.com/mi-com-product/fly-birds/xiaomi-power-bank-10000mah-22w-lite/pc/0788fd841fc0eb122e99b08306af573a.jpg',alt:'Power Bank Xiaomi 10000mAh'}]}],
  ...
  },
  {
    ...
    variants:[{name:'Padrão',swatch:'#111111',images:[{src:'https://images.contentstack.io/v3/assets/blt7e9bdfb5b3e9fadb/bltb12106f9b21a3613/69819f96c2dc571787eff6d6/Roku-Express-2020-650.jpg',alt:'Roku Express com controle remoto'}]}],
  ...
  },
  {
    ...
    variants:[{name:'Padrão',swatch:'#1f1f1f',images:[{src:'https://us.amazfit.com/cdn/shop/files/20230725-155407.jpg?v=1715288783&width=416',alt:'Smartwatch Amazfit Bip 5'}]}],
  ...
  },
  {
    ...
    variants:[{name:'Padrão',swatch:'#171717',images:[{src:'https://shop.samsung.com/latin/cac/pub/media/catalog/product/s/m/sm-a055_galaxy-a05_all-logo_thumb.png',alt:'Samsung Galaxy A05'}]}],
  ...
  },
  {
    ...
    variants:[{name:'Padrão',swatch:'#f4f4f4',images:[{src:'https://i02.appmifile.com/782_operator_sg/29/01/2024/6d88681c6abc105ea1c5373100fcd2c7.jpg',alt:'Fones Redmi Buds 5 com estojo'}]}],
